...
{
    internal class Json : IEnumerable
    {
#if POOLING
	...
	public float f {
        ...
        public long i;
        public bool b;
        public delegate void AddJSONContents(Json self);

        public static Json nullJO { get { return Create(Type.NULL); } } //an empty, null object
        public static Json obj { get { return Create(Type.OBJECT); } }      //an empty object
        public static Json arr { get { return Create(Type.ARRAY); } }       //an empty array
	...
	public JSONObject(double d) {
        ...
        public Json(Dictionary<string, Json> dic)
        {
            type = Type.OBJECT;
            keys = new List<string>();
            list = new List<Json>();
        ...
        public Json(AddJSONContents content)
        {
            content.Invoke(this);
        }
        public Json(Json[] objs)
        {
            type = Type.ARRAY;
            list = new List<Json>(objs);
        }
        ...
        public static Json StringObject(string val) { return CreateStringObject(val); }
        public void Absorb(Json obj)
        {
        ...
        public static Json Create(Type t)
        {
            Json obj = Create();
            obj.type = t;
            switch (t)
        ...
        public static Json Create(bool val)
        {
            Json obj = Create();
            obj.type = Type.BOOL;
            obj.b = val;
        ...
        public static Json Create(float val)
        {
            Json obj = Create();
        ...
        public static Json Create(int val)
        {
            Json obj = Create();
            obj.type = Type.NUMBER;
            obj.n = val;
        ...
        public static Json Create(long val)
        {
            Json obj = Create();
            obj.type = Type.NUMBER;
            obj.n = val;
        ...
        public static Json CreateStringObject(string val)
        {
            Json obj = Create();
        ...
        public static Json CreateBakedObject(string val)
        {
            Json bakedObject = Create();
        ...
        /// <returns></returns>
        public static Json Create(string val, int maxDepth = -2, bool storeExcessLevels = false, bool strict = false)
        {
            Json obj = Create();
            obj.Parse(val, maxDepth, storeExcessLevels, strict);
            return obj;
        }
        public static Json Create(AddJSONContents content)
        {
            Json obj = Create();
            content.Invoke(obj);
            return obj;
        }
        public static Json Create(Dictionary<string, string> dic)
        {
            Json obj = Create();
        ...
        public Json() { }
        #region PARSE
        public Json(string str, int maxDepth = -2, bool storeExcessLevels = false, bool strict = false)
        ...
        public delegate void GetFieldResponse(Json obj);
...
#pragma warning restore 219
        ...
        #endregion
#if UNITY_2 || UNITY_3 || UNITY_4 || UNITY_5
        public static implicit operator WWWForm(Json obj)
        {
        ...
        public static implicit operator bool(Json o)
        {
            return o != null;
        }
#if POOLING
    ...
    internal class JSONObjectEnumer : IEnumerator
    {
        public Json _jobj;
        ...
        public JSONObjectEnumer(Json jsonObject)
        {
