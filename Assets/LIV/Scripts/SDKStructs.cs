...
namespace LIV.SDK.Unity
{
    ...
    {
        public const string SDK_ID = "JUOVPCTUUHHUUNSIF6HVPBXTT74FTRUO";
...
{0} {1}",
    ...
    public struct SDKPriority
    {
        ...
        public override string ToString()
        {
            return string.Format(
@"Priority:
pose: {0}, clipPlane: {1}, stage: {2}, resolution: {3}, feature: {4}",
                pose, clipPlane, stage, resolution,
                feature);
        }
    }
...
trackedSpaceWorldToLocalMatrix: {4}",
                ...
                trackedSpaceWorldRotation,
                trackedSpaceLocalScale,
                trackedSpaceLocalToWorldMatrix,
                trackedSpaceWorldToLocalMatrix);
        }
    }
