...
namespace LIV.SDK.Unity
{
    public static class SDKUtils
    {
        ...
        {
            RENDERING_PIPELINE renderingPipeline = render.cameraInstance == null ? RENDERING_PIPELINE.UNDEFINED : SDKUtils.GetRenderingPipeline(render.cameraInstance.actualRenderingPath);
